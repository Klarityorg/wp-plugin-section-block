 ...
 * @since 1.0.0
 */
function full_width_container_cgb_block_assets() { // phpcs:ignore
	// Styles.
	wp_enqueue_style(
		'full_width_container-cgb-style-css', // Handle.
...
add_action( 'enqueue_block_assets', 'full_width_container_cgb_block_assets' );
 ...
 * @since 1.0.0
 */
function full_width_container_cgb_editor_assets() { // phpcs:ignore
	// Scripts.
	wp_enqueue_script(
		'full_width_container-cgb-block-js', // Handle.
	...
	// Styles.
	wp_enqueue_style(
		'full_width_container-cgb-block-editor-css', // Handle.
...
// Hook: Editor assets.
add_action( 'enqueue_block_editor_assets', 'full_width_container_cgb_editor_assets' );
